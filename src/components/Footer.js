        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <address className="not-italic">
              <div className="mb-4">
                <p className="font-semibold mb-1">Juba Office</p>
                <p className="mb-2">Ministries Road, Thongpiny</p>
                <p className="mb-2">Juba, South Sudan</p>
                <p className="mb-2">
                  <a href="tel:+211920504110" className="hover:text-conison-magenta transition-colors">+211 92 050 4110</a>
                </p>
              </div>
              <div>
                <p className="font-semibold mb-1">Nairobi Office</p>
                <p className="mb-2">TRM ALONG THIKA SUPERHIGHWAY</p>
                <p className="mb-2">
